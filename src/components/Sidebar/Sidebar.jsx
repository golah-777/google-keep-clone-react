...
function Sidebar() {
  ...
  const handleOnMouseOver = () => setAside(() => true);
  const handleOnMouseOut = () => setAside(() => false);
  return (
    <div
      className="sidebar"
      ...
      style={{ 
        width:aside === true && '280px',
        borderRight:aside === true && "1px solid #e0e0e0",
        boxShadow:aside === true &&  "0 1px 2px 0 rgba(60,64,67,0.302), 0 2px 6px 2px rgba(60,64,67,0.149)"
      }}
    >
      <div className="sidebar-items active-item" style={{background: aside === true && '#feefc3'}}>
        <div className="icons active" style={{background: aside === true && '#feefc3'}}>
          <svg
