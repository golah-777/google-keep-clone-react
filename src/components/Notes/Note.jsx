...
export default function Note(props){
  ...
  return(
       <div className="note" onMouseOver={ mouseOver } onMouseOut={ mouseOut }>
        <div className="check-note" style={{visibility: overNote === true && "visible"}}>
        ...
        <div className="title-note">
         ...
         <div className="icons" style={{visibility: overNote === true && "visible"}}>
        ...
        <div className="footer-note" style={{visibility: overNote === true && "visible"}}>
        <>
          <div className="icons">
