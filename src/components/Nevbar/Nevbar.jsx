  ...
  return(
    <nav>
      ...
      <div className="icons">
        ...
        <div className="tooltip one">Main menu</div>
      </div>
      <img className="gb_Pc gb_Od" src="https://www.gstatic.com/images/branding/product/1x/keep_2020q4_48dp.png" />
      <h2>Keep</h2> 
    </div>
